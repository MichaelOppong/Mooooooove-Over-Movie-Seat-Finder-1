...
var movieReviewAladdin = [
    "The best movie this year love Aladdin!",
    "I laughed, I cried, then I laughed again really love Aladdin!",
...
var movieChoice;
$(".buy").hide();
$(".ticketSelection").hide();
$(".checkout").hide();

$(".pokemon").click(function() {
    movieChoice = "Pokemon Detective";
...
$("img").click(function() {
    $(".ticketSelection").show();
    $(".checkout").show();
    $(".movieChoice").text(`Enter the number of tickets you would like to purchase for ${movieChoice}`);
});